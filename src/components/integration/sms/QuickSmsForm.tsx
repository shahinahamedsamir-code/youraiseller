  ...
  return (
    <div className={clsx(compact ? "space-y-3" : "space-y-4")}>
      ...
      <label className="block">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none rounded-xl border border-slate-200 bg-white py-2.5 pl-3 pr-10 text-sm font-semibold text-slate-800 outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-100 disabled:opacity-60"
          >
            <option value="">
              {templates.length === 0
      ...
      <textarea
        ...
        className="w-full resize-y rounded-xl border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-100 disabled:opacity-60"
      />
      <input
        type="text"
        value={phones}
        ...
        disabled={!systemEnabled}
        className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-100 disabled:opacity-60"
      />
      ...
      <button
        ...
        onClick={handleSend}
        className={clsx(
          "inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-500 px-4 py-2.5 text-sm font-extrabold text-white shadow-md shadow-teal-200/50 disabled:opacity-60",
          !compact && "w-auto px-6"
        )}
      >
        {sending ? (
