...
define('YOURAI_PLUGIN_VERSION', '1.10.1');
...
function yourai_fetch_update_info() {
    ...
    // Short cache so "Check Again" / the Plugins page sees new versions quickly.
    set_transient('yourai_update_info', $data, 10 * MINUTE_IN_SECONDS);
    return $data;
}
